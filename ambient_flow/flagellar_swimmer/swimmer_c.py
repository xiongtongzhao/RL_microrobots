...
CcenterX=4
CcenterY=4
Ccenter_array=np.array([CcenterX,CcenterY])
...
#                 CcenterY=9
        ...
        if     self.it%1==0 :
            ...
            np.savetxt('Ccenter.pt',Ccenter_array.copy() ,delimiter=',')
...
# #             reward+=self.X*100#done = True
    ...
    def reset(self):
        ...
        self.done=False
#         CcenterX=9+(np.random.rand()-0.5)*3
#         CcenterY=0+(np.random.rand()-0.5)*3
#         CcenterX=6
#         CcenterY=0
#         CcenterXc=0
#         CcenterYc=6
