The codes to achieve a chain swimmer's chemotaxis towards a moving source will generate two directories (traj, traj2) to store the swimmer's data. 
...
Each column corresponds to: X coordinate of centroid, Y coordinate of centroid, swimmer's moving dirction, X coordinate of the swimmer's back end, Y coordinate of the swimmer's back end, X coordinate of centroid, Y coordinate of centroid.
