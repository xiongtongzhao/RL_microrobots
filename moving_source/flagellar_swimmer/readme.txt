...
Each line corresponds to: X coordinate of centroid, Y coordinate of centroid, swimmer's moving dirction, X coordinate of the swimmer's back end, Y coordinate of the swimmer's back end, X coordinate of source, Y coordinate of source.
