...
#             self.pressure_index=0
        ...
        #each line corresponds to: X coordinate of centroid, Y coordinate of centroid, X coordinate of the end at the first link, Y coordinate of the end at the first link
#         if traj3==[]:
#             traj3=mm
#         else:
...
#             traj4=np.concatenate((traj4.reshape(-1,N-1),action.reshape(1,-1)),axis=0)
        ...
        #each line corresponds to:pressure at the end of the first link, pressure at all hinges, pressure at the end of the last link
#         if     self.it%1000==0 :
